...
- osTicket 1.15.8 (or latest version) [(download)](https://osticket.com/download/)
...
- PHP Manager for IIS 1.5.0 (or latest version) [(download)](https://www.iis.net/downloads/community/2018/05/php-manager-150-for-iis-10)
...
- (NOTE: Internet Information Services (IIS) is Microsoft's web server software that runs on Windows Server and Windows desktop operating systems. It serves web content (HTML, ASP.NET, etc.), handles HTTP requests, and supports various web technologies. Common Gateway Interface (CGI) is a standard protocol that allows web servers (like IIS) to execute external programs/scripts (Perl, Python, C++, etc.) and generate dynamic web content.)
...
<p>
The next prerequisite PHP is a ZIP file which needs to be extracted to the C: drive in a PFP folder (C:\PFP). To do this, navigate to the C: drive with File Explorer, right-click inside the window to show the options menu, then go down to "New" and select "Folder". Name that folder "PHP". Now go to the ZIP folder, right-click on it and select "Extract all". Change the destination where the files will be extracted to "C:\PHP" and click "Extract". Please wait for the extraction process to complete.
</p>
<p>
...
<p>
The next prerequisites to install are VC_redist.x86.exe and MySQL.
</p>
<p>
...
<p>
<img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462886857409957918/image.png?ex=696fd30d&is=696e818d&hm=c82e713233cb625a6adb017c7723e5d74e9f341c1419033f0104664fc2e32ac1" height="30%" width="30%"/> <img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462887212814438442/image.png?ex=696fd362&is=696e81e2&hm=993e5fb1b9816b65c370269841bc3f8b6d771d1a6c937e9d0e6683a677f6377d" height="30%" width="30%"/> <img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462887610191057167/image.png?ex=696fd3c1&is=696e8241&hm=2a92293bff2f11d862f522a3ec6c68f7a664b4c2a27d332cb398015b5c6696d8" height="30%" width="30%"/>
</p>
<p>
When the Configuration Wizard pops up, I will select "Standard Configuration" and click "Next". I will click "Next" again as I will not be changing anything. The next window will have the option to make a root password under "Modify Security Settings", or "Create An Anonymous Account". I will use the root password option. It's advised you make a very strong root password, but for this demonstration I will be using a simple password called "root". I will click "Next", and then select "Execute". Please wait for the Wizard to complete, then select "Finish"
</p>
<p>
<img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462897098499424469/image.png?ex=696fdc97&is=696e8b17&hm=4f545d7341eeee879489a14a3c7ed6f24de40f61fa14d1626f4f9c0efdd8b2c1" height="30%" width="30%"/> <img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462891224074813586/image.png?ex=696fd71f&is=696e859f&hm=e56fe6ecaa62131af3de9560ca6009af9645e6f153125750fb02c03bddb798aa" height="30%" width="30%"/> <img src="https://cdn.discordapp.com/attachments/1390632590247067770/1462907574692085821/image.png?ex=696fe659&is=696e94d9&hm=7492db07b9f08b2ba7fe4f9ab64abbb687ae2289eb6927e66144f1a8bd43ee78" height="30%" width="30%"/>
</p>
<p>
edit
</p>
